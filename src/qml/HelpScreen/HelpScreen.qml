        ...
        Column {
            ...
            Text {
                ...
                text: "<b><h3>Turntable</h3></b>" +
                      ...
                      "The sample can be scratched with finger, played " +
                      ...
                      "three beats that are saved to the devices memory " +
                      "whenever they are edited. Use the beat selector " +
            ...
            Text {
                ...
                text: "<b><h3>Samples</h3></b>" +
                      "The turntable melody sample <i>ivory.wav</i> was " +
                      "created by nick <i>Flick3r</i> and it was downloaded " +
                      "from <a href=\"http://www.freesound.org\">" +
